...
static int lchacha_proc_show(struct seq_file* m, void* v) {
    seq_printf(m,
            ...
            (u64)atomic64_read(&lchacha_stats.writes), (u64)atomic64_read(&lchacha_stats.ioctls), (u64)atomic64_read(&lchacha_stats.bytes_processed),
            (u64)atomic64_read(&lchacha_stats.blocks), (u64)atomic64_read(&lchacha_stats.current_buffer_bytes), (u64)atomic64_read(&lchacha_stats.errors));
    return 0;
#undef K
}
